...
public class DrivoTankWithPID extends CommandBase {
    ...
    public DrivoTankWithPID(Drivetrain drivetrain, PIDSettings leftPIDSettings, PIDSettings rightPIDSettings,
    ...
    public void execute() {
        ...
        double leftSpeed = (leftPIDController.calculate(leftSource.get()) +
                leftFeedForwardController.calculate(leftSetpoint.get()) / 2);
        double rightSpeed = rightPIDController.calculate(rightSource.get()) +
