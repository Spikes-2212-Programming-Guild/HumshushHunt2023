...
public class SplooshAndVamooseWindow extends BasePathAuto {

    private static final double MAX_VELOCITY = 2.5;
    private static final double MAX_ACCELERATION = 2;

    public SplooshAndVamooseWindow(Drivetrain drivetrain) {
        super(drivetrain, getEventMap());
    }

    public CommandBase getCommand() {
        return fullAuto(PathPlanner.loadPathGroup("Sploosh And Vamoose Window",
